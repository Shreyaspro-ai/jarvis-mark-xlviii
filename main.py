...
TOOL_DECLARATIONS = [
    ...
    },
    {
        ...
        "description": "Manages files and folders: list, create, delete, move, copy, rename, read, write, find, disk usage, and open (in Explorer).",
        "parameters": {
            "type": "OBJECT",
            "properties": {
                ...
                "path":        {"type": "STRING", "description": "File/folder path or shortcut. Shortcuts (desktop, downloads, documents, pictures, music, videos, home) may be used alone OR as the first segment, e.g. 'desktop/AgentTest'. Prefer these shortcuts over bare relative paths."},
    ...
    {
        "name": "agent_mode",
        "description": "Autonomous agent for complex, open-ended tasks on this computer: it reads and edits existing files, runs shell commands, checks the results, and iterates until the task is truly done — deep, careful, multi-step work (not one-shot). Use for things like 'fix the bug in my project', 'analyze this folder and refactor it', 'set up and run this script', 'investigate why X fails'. Prefer a simpler direct tool when one exists.",
        "parameters": {
            "type": "OBJECT",
            "properties": {
                "goal":        {"type": "STRING", "description": "The full task to accomplish, described clearly."},
